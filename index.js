let questions = [
    ...
    {
    numb: 4,
    question: "What is the primary purpose of forking a repository in a collaborative development workflow?",
    answer: "Contribute changes to someone else's project without directly modifying the original",
    options: [
...

  {
    ...
    answer: "To end the loop and transfer control to the next statement outside the loop",
    options: [
